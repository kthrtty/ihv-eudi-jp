...
const info = annexCSessionTranscript({ base64EncryptionInfo, serializedOrigin: 'https://verifier.ihv.example' });
...
const stD = annexDSessionTranscript({ origin: 'https://verifier.ihv.example', nonce: 'n-0S6_WzA2Mj', jwkThumbprint: 'lU2TGgf17pOvZbQeAhyfm0q9wn8fpfFXaJdN0Vw20dk' });
