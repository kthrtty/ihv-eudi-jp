...
// `islands` は**申請フォームの選択肢そのもの**（自由入力にしない）。列挙のある地域は島ごとに
// 分け、甑島列島・トカラ列島のように出典が列島名で括っているものはその単位のまま。
...
const SEED = [
  ...
  m('43205', '熊本県', '水俣市', '水俣市長'),
  m('43208', '熊本県', '山鹿市', '山鹿市長'),
  m('43210', '熊本県', '菊池市', '菊池市長'),
  m('43212', '熊本県', '上天草市', '上天草市長'),
  m('43215', '熊本県', '天草市', '天草市長'),
  m('43216', '熊本県', '合志市', '合志市長'),
  m('43348', '熊本県', '美里町', '美里町長'),
  m('43403', '熊本県', '大津町', '大津町長'),
  m('43404', '熊本県', '菊陽町', '菊陽町長'),
  m('43444', '熊本県', '甲佐町', '甲佐町長'),
  m('43468', '熊本県', '氷川町', '氷川町長'),
  m('43482', '熊本県', '芦北町', '芦北町長'),
  m('43484', '熊本県', '津奈木町', '津奈木町長'),
